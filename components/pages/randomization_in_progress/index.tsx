...
export default function RandomizationInProgress() {
  return (
    <div className="bg-surface overflow-y-auto text-on-surface min-h-screen flex flex-col">
      ...
      <header className="bg-white/80 dark:bg-slate-950/80 backdrop-blur-md text-primary dark:text-slate-100 font-manrope headline-md tracking-tight docked full-width top-0 z-50 border-b border-slate-200/15 shadow-sm flex justify-between items-center w-full px-8 py-3 fixed">
        ...
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-4 text-on-surface-variant">
            <span className="material-symbols-outlined hover:bg-slate-100 p-2 rounded-lg transition-all cursor-pointer">security</span>
            <span className="material-symbols-outlined hover:bg-slate-100 p-2 rounded-lg transition-all cursor-pointer">notifications</span>
            <span className="material-symbols-outlined hover:bg-slate-100 p-2 rounded-lg transition-all cursor-pointer">help</span>
          </div>
          <div className="flex items-center gap-3 pl-4 border-l border-slate-200">
            <div className="text-right hidden sm:block">
              <p className="text-xs font-bold text-primary">Administrator Profile</p>
              <p className="text-[10px] text-on-surface-variant uppercase tracking-tighter">Master Key Holder</p>
            </div>
            <img alt="Administrator Profile" className="w-9 h-9 rounded-full ring-2 ring-tertiary-fixed-dim" src="https://lh3.googleusercontent.com/aida-public/AB6AXuC-oYPBcXNlUFsHk6V7Y3_FJho534lXlENB13y5_vlzDL5QnNfvo2JYv1H7bErPxaQ0wnL5DxqxrdstblYP5wEjI0BdbfvAnpmBaU0Jcy4BU4to1kSYqziyZJnuEaS3KJTDo-vy3HKbcUUZpdbw_SkYwOYb4LNAIJPxSk9lyZtw2BkjRxcrcZRFo4I7WGycHf_3-zM9SmYiGNPcD5bP8vFCIPlVs04i8T0NsqRNP4F9u84SlbND03u5Pfe8W200mGyhMN1tcjUl" />
          </div>
        </div>
      </header >
        ...
        <main className="flex-1 p-8 bg-surface">
          ...
          <div className="mb-12 flex justify-between items-end">
            ...
            <div className="flex items-center gap-4">
              ...
              <button className="bg-white border border-error/20 text-error px-6 py-3 rounded-xl font-bold flex items-center gap-2 hover:bg-error-container/20 transition-all shadow-sm active:scale-95">
      ...
      {/* <!-- Security Status Bar --> */}
      <footer className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-slate-200 px-8 py-2 flex items-center justify-between text-[10px] font-bold text-on-surface-variant uppercase tracking-widest">
        <div className="flex items-center gap-6">
